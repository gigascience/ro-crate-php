...
class ROCrateTest extends TestCase
{
    ...
    public function testAddPropertyPair(): void
    {
        ...
        $root->addPropertyPair('creator', '#alice', true)
            ->addPropertyPair('creator', '#bob')->addPropertyPair('creator', '#cathy');
    ...
    public function testManipulatePropertyPair(): void
    {
        ...
        $root->addPropertyPair('creator', '#alice', true)->addPropertyPair('creator', '#bob')
            ...
            ->addPropertyPair('creator', '#alice', true)->addPropertyPair('creator', '#bob');
    ...
    {
        $strings = ["", "23", "asdada", "-2015-04", "0862", "0000-03-02", "0000-53-02",
         "2346-06,19", "2025-08-04T10:30:45Z", "2030-12-25T08:00:00+02:00",
          "1999-07-14T23:59:59-05:00", "-2024-02-29T00:00:00Z", "-0044-03-15T09:30:00+03:00",
           "2023-12-31T23:59:59-11:30"];
    ...
    {
        $strings = ["http://example.com", "https://sub.example.com/path?q=val", "ftp://files.example.com",
         "path/to/file", "path/to/file", "//example.com", "file.txt?query=abc#section", "invalid|path",
          "space in url", "percent%2G"];
    ...
    {
        $strings = ["http://example.com", "https://sub.example.com/path", "ftp://files.example.com",
         "mailto:contact@example.com", "//example.com", "example.com", "/path/to/file"];
